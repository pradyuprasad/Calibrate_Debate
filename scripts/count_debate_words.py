...
if __name__ == "__main__":
    ...
    print(f"Prompt tokens - mean: {stats['prompt_tokens'][0]:,.0f}, variance: {stats['prompt_tokens'][1]:,.0f}")
    print(f"Completion tokens - mean: {stats['completion_tokens'][0]:,.0f}, variance: {stats['completion_tokens'][1]:,.0f}")
